...
export default function Home() {
  const [fondo, setFondo] = useState('#C099FF');
  ...
  return (
    <main style={{ backgroundColor: fondo, padding: '2rem', minHeight: '100vh' }}>
      ...
      <Titulo texto='Practica 2' color='navy' tamaño='5rem' fuente='Arial'/>
      <Contador />
      <CambiarImagen />
      <CambiarFondo onCambiarColor={setFondo} />

      <hr style={{ margin: '2rem 0', border: 'none', height: '2px', backgroundColor: 'white' }} />
      <Titulo texto='Practica 3' color='navy' tamaño='5rem' fuente='Arial'/>
      <ToastAzul/> 
      <br />
      <br /> 
      <Modal />
      ...
      <hr style={{ margin: '2rem 0', border: 'none', height: '2px', backgroundColor: 'white' }} />
      <Titulo texto='Practica 4' color='navy' tamaño='5rem' fuente='Arial'/>
      <Tabla/>
    </main>
  );
}
